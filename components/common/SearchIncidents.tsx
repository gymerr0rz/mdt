  ...
  return (
    <>
      <div className="flex w-full flex-col  gap-3">
        <div className="flex max-h-[42px] rounded-[5px] items-center w-full border border-1 px-3 py-2 gap-1  ">
          <svg
            width="20"
            height="20"
            viewBox="0 0 20 20"
          ...
          <input
            ...
            className="bg-transparent outline-none font-kulim font-bold w-full"
        ...
        <div className="flex justify-start gap-5">
          {results?.map((res, idx) => (
            <Link
              ...
              key={idx}
              className="w-full flex gap-2 bg-2 max-w-96 px-5 py-2 rounded-xl hover:bg-white/5 cursor-pointer transition-colors"
            >
              <div className="min-w-20 min-h-20 bg-2 border border-1 rounded-full" />
