      ...
      <div className="px-5">
        ...
        <ul className="flex flex-col gap-2 py-12 ">
          <li id="dispatch">
            <Link
              href="#"
              className={`flex gap-3 font-kulim font-bold w-52 py-2  rounded-sm transition-colors ${
                path === '/'
          ...
          <li id="profiles">
            <Link
              href="#"
              className="flex gap-3 text-3 font-kulim font-bold w-52 py-2 hover:bg-2 rounded-sm transition-colors hover:text-1 group justify-start  h-14 px-5 items-center"
            >
              <svg
                width="30"
                height="30"
                viewBox="0 0 16 20"
                fill="none"
                className="fill-3 group-hover:fill-1 transition-colors"
              >
          ...
          <li id="citations">
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
                fill="none"
                className="stroke-3 group-hover:stroke-[#3CE7D2] transition-colors"
              >
                <path
