      ...
      <div className="flex w-full px-5 py-10 gap-5 ">
        <div className="flex w-3/5 flex-col gap-5">
          <div className=" w-full flex gap-5 items-center">
            <BackButton href="/citations" />
            <div className="w-full from-2 from-40% h-12 bg-gradient-to-r to-transparent flex px-5  justify-start gap-2 items-center">
              ...
              <span className="  font-bold">Issue a Vehicle Citations</span>
            </div>
          </div>
          <div className="flex flex-col gap-5">
            ...
            <Input
              id="plate"
              name="plate"
              placeholder="Enter a vehicle plate..."
              value="XXXX-XXXX"
            />
            <Input
              id="driver"
            ...
            <Input
              ...
              value="Lorem ipsum dolor sit amet consectetur adipiscing elit Ut et massa mi. Aliquam in hendrerit urna. Pellentesque sit amet sapien fringilla, mattis ligula consectetur, ultrices mauris. Maecenas vitae mattis tellus.."
            />
            <Input
              id="department"
              name="department"
            ...
            <Input
              id="officer"
              name="officer"
              placeholder="Enter a officer..."
              value="[304] M. FlexTown"
            />
            <Input
              id="fine"
              name="fine"
              placeholder="Enter a fine..."
              value="$300"
            />
            <Button
              variant="default"
              size="default"
              className="flex gap-2 text-1"
            >
              <svg
                stroke="currentColor"
                fill="currentColor"
        ...
        <div className="w-2/5 flex flex-col gap-5">
          ...
          >
            <span className="flex gap-5 items-center">
              <h1>
                Recommended fine: <b className="text-1 font-normal">$300</b>
              </h1>
            </span>
          </div>
